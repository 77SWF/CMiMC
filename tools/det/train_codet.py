...
from CMiMC.utils.CoDetModule_DIM import *

from CMiMC.utils.MMI_DIM import DeepMILoss
...
if __name__ == "__main__":
    ...
    # # debug params
    # args.data ='CMiMC/data/V2X-Sim-1-det/train'
    # args.com = 'disco'
    # args.batch = 4
    # args.kd_flag =0
    ...
    # args.logpath = 'CMiMC/tools/det/logs_v1_hyperpara_seed{}/logs_lr{}_{}_L{}+G{}'.format(
