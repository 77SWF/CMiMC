...
from CMiMC.utils import mapping
from CMiMC.configs import Config
from CMiMC.utils.data_util import voxelize_occupy
from CMiMC.utils.obj_util import *
from CMiMC.utils.nuscenes_pc_util import (
...
from CMiMC.utils.v2x_sim_scene_split_v1.parser import parse_scene_files
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-r",
        "--root",
        default="/home/CMiMC/data/V2X-Sim-1-origin",
        type=str,
    ...
    parser.add_argument(
        "-p",
        "--savepath",
        default="/home/CMiMC/data/V2X-Sim-1.0-trainval/",
        type=str,
    ...
    scene_files_loc = '/home/CMiMC/utils/v2x_sim_scene_split_v1'
